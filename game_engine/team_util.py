...
RELATIVE_TEAM_DISTANCE = 0.7
RELATIVE_TEAM_HALF_DISTANCE = RELATIVE_TEAM_DISTANCE*0.5

VELOCITY_CHECK_MODULE_RANGE = 21
VELOCITY_CHECK_DAMAGE = 2

ZONE_CHECK_MODULE_RANGE = 31
SOFT_BORDER_ZONE_CHECK_DAMAGE = 3
HARD_BORDER_ZONE_CHECK_DAMAGE = 10
